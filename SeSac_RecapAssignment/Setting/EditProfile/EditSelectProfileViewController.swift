...
extension EditSelectProfileViewController: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        ProfileImage.updateSelectedImage(mainImageView: mainImageView, userDefaultsKey: "tempProfile", selectedItem: indexPath.item)
